...
namespace XehnBoost.Views
{
    ...
    public partial class Container : Window
    {
        public Container()
        {
            ...
            try
            {
                if (!webClient.DownloadString("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/version.txt").Contains("2.9.4"))
                {
                    string message = "New Update Available, click OK to Open the download link";
                    MessageBox.Show(message);
                    Process.Start(@"C:\Windows\explorer.exe", "https://github.com/xehn1337/XehnBoost/releases");
                }
            }
            catch
            {
