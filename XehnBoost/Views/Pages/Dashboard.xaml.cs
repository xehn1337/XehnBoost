...
namespace XehnBoost.Views.Pages
{
    /// <summary>
    ...
    public partial class Dashboard : Page
    {
        ...
        private void Button_Click1(object sender, RoutedEventArgs e) // Download & Enable Full-screen Exclusive.
        {
            ...
            webClient.DownloadFile("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/FSE.bat", "FSE.bat");
        ...
        private void Button_Click2(object sender, RoutedEventArgs e) // Download & Install TRS.
        {
            ...
            WebClient webClient = new WebClient();
            webClient.DownloadFile("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/TimerResolutionService.bat", "TimerResolutionService.bat");
        ...
        private void Button_Click3(object sender, RoutedEventArgs e) // Download & Install XehnBoost PowerPlan.
        {

            WebClient webClient = new WebClient();
            webClient.DownloadFile("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/ImportPowerPlan.bat", "ImportPowerPlan.bat");
            ...
            string message = "XehnBoost PowerPlan Applied!";
            MessageBox.Show(message);
        }
        ...
        private void Button_Click4(object sender, RoutedEventArgs e) // Debloat Startup Telemetry.
        {
            ...
            WebClient webClient = new WebClient();
            webClient.DownloadFile("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/DisableTelemetry.bat", "DisableTelemetry.bat");
        ...
        private void Button_Click5(object sender, RoutedEventArgs e) // Debloat Powersaving.
        {
            ...
            WebClient webClient = new WebClient();
            webClient.DownloadFile("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/DisablePowerSaving.bat", "DisablePowerSaving.bat");
        ...
        private void Button_Click7(object sender, RoutedEventArgs e) // Apply SystemProfile Tweaks.
        {
            ...
            WebClient webClient = new WebClient();
            webClient.DownloadFile("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/DisableServices.bat", "DisableServices.bat");
        ...
        private void Button_Click8(object sender, RoutedEventArgs e) // Apply SystemProfile Tweaks.
        {
            ...
            WebClient webClient = new WebClient();
            webClient.DownloadFile("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/Remove%20preinstalled.bat", "removepreinstalled.bat");
        ...
        private void Button_Click9(object sender, RoutedEventArgs e) // Apply SystemProfile Tweaks.
        {
            ...
            WebClient webClient = new WebClient();
            webClient.DownloadFile("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/ApplyAllTweaks.bat", "ApplyAllTweaks.bat");
        ...
        private void Button_Click10(object sender, RoutedEventArgs e) // Apply SystemProfile Tweaks.
        {
            ...
            WebClient webClient = new WebClient();
            webClient.DownloadFile("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/TaskManager.bat", "TaskManager.bat");
