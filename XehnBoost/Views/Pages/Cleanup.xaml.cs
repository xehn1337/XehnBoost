...
namespace XehnBoost.Views.Pages
{
    ...
    public partial class Cleanup : Page
    {
        ...
        private void Button_Click1(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            webClient.DownloadFile("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/Clean-up/ClearTempFiles.bat", "ClearTempFiles.bat");
        ...
        private void Button_Click2(object sender, System.Windows.RoutedEventArgs e)
        {
                ...
                WebClient webClient = new WebClient();
                webClient.DownloadFile("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/Clean-up/ClearLogFiles.bat", "ClearLogFiles.bat");
        ...
        {
            WebClient webClient = new WebClient();
            webClient.DownloadFile("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/Clean-up/RunCleanmgr.bat", "RunCleanmgr.bat");
        ...
        {
            WebClient webClient = new WebClient();
            webClient.DownloadFile("https://raw.githubusercontent.com/xehn1337/XehnBoost/main/v2/Clean-up/CleanUpAll.bat", "CleanUpAll.bat");
